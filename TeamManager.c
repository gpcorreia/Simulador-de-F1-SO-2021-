...
void *Carro(inx *aux)
{
    ...
    while (TotalDistance > 0)
    {
        ...
        else
        {
            ...
            else if ((( (EquipasSHM[aux->team].cars[aux->car].oilcap) - ((fourLaps * EquipasSHM[aux->team].cars[aux->car].consumption) / (EquipasSHM[aux->team].cars[aux->car].speed) )) <= 0) && ((EquipasSHM[aux->team].cars[aux->car].state == 0) || (EquipasSHM[aux->team].cars[aux->car].state == 1) ) )
            {
                ...
                if (EquipasSHM[aux->team].pitbox.state == 1)
                {
